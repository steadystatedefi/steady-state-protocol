...
struct WeightedPoolParams {
  ...
  uint16 coverageForepayPct;
  /// @dev an amount of coverage usable as collateral drawdown, where 0% stops drawdown. MUST: maxUserDrawdownPct + coverageForepayPct <= 100%
